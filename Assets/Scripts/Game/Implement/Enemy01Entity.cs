...
{
    public class Enemy01Entity : EnemyEntity
    {
        private const float cRadius = 0.55f;
        private Vector2 cOffset = new Vector2(0, 0.5f);
        private const float cMoveSpeed = 1.5f;
